import { DOCX_EDITOR_DATA_VERSION, DOCX_EDITOR_SCHEMA_VERSION, getTextFromElementList } from '@wanghe1995/docx-editor-schema'
import type { IEditorResult, IElement, IGetValueOption } from '@wanghe1995/docx-editor-schema'
import { ElementType } from '@wanghe1995/docx-editor-schema'
import RuntimeWorker from './runtime.worker?worker&inline'
import type { IWorkerRequest, IWorkerResponse, IWorkerTaskPayload, WorkerRequestType } from './WorkerMessage'
