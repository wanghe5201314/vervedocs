...
import { IEditorData, IEditorOption } from '@wanghe1995/docx-editor-schema'
...
import { ControlBorder } from './Border'
...
export class Control {
  ...
  public emitControlChange(state: ControlState) {
    ...
    const isSubscribeControlChange = this.eventBus.hasSubscribers('controlChange')
  ...
  public emitControlContentChange(options?: IControlChangeOption) {
    const isSubscribeControlContentChange = this.eventBus.hasSubscribers(
