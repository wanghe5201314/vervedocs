...
import { DOCX_EDITOR_DATA_VERSION, ZERO } from '@wanghe1995/docx-editor-schema'
...
import { IRow, IRowElement } from '@wanghe1995/docx-editor-schema'
import { deepClone, getUUID, nextTick } from '@wanghe1995/docx-editor-schema'
import { Cursor } from '../cursor/Cursor'
import { CanvasEvent } from '../event/CanvasEvent'
import { GlobalEvent } from '../event/GlobalEvent'
import { HistoryManager } from '../plugin-stubs'
import { Listener } from '@wanghe1995/docx-editor-state'
import { Position } from '../position/Position'
import { RangeManager } from '@wanghe1995/docx-editor-state'
import { Background } from '../frame/Background'
import { getSeparatorRenderHeight } from '../utils/separator'
import { Highlight } from '../richtext/Highlight'
import { ParagraphColor } from '../richtext/ParagraphColor'
...
import { DeepRequired, IPadding } from '@wanghe1995/docx-editor-schema'
import {
  ControlComponent,
  ControlIndentation
} from '@wanghe1995/docx-editor-schema'
import { formatElementList, isParagraphSeparator, isTableElement, isImageElement } from '@wanghe1995/docx-editor-schema'
import { WorkerManager } from '../plugin-stubs'
import { Previewer } from '../particle/previewer/Previewer'
import { DateParticle } from '../plugin-stubs'
import { IMargin } from '@wanghe1995/docx-editor-schema'
import { BlockParticle } from '../plugin-stubs'
import { EDITOR_COMPONENT, EDITOR_PREFIX } from '@wanghe1995/docx-editor-schema'
...
import { EventBus } from '@wanghe1995/docx-editor-state'
import { EventBusMap } from '@wanghe1995/docx-editor-schema'
import { Group } from '../interactive/Group'

import { Override } from '../plugin/override/Override'
import { FlexDirection, ImageDisplay } from '@wanghe1995/docx-editor-schema'
import { PUNCTUATION_REG } from '@wanghe1995/docx-editor-schema'
    ...
    for (let i = 0; i < elementList.length; i++) {
      ...
      if (curRow.offsetX === undefined && (listOffsetX || paragraphIndentX || paragraphFirstLineIndent)) {
        ...
        const firstIndent = isListParagraph
          ? 0
          : Math.max(0, isParagraphFirstRow ? paragraphFirstLineIndent : 0)
        curRow.offsetX =
          listOffsetX +
          listIndentX +
          paragraphIndentX +
