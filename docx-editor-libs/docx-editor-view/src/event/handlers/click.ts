import { ZERO, TEXTLIKE_ELEMENT_TYPE, NUMBER_LIKE_REG, ElementType, IRange, IElement, isParagraphSeparator } from '@wanghe1995/docx-editor-schema'
...
function handleTripleClick(host: CanvasEvent) {
  const draw = host.getDraw()
  const position = draw.getPosition()
