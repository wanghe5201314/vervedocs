...
import { VIRTUAL_ELEMENT_TYPE } from '@wanghe1995/docx-editor-schema'
import { ElementType } from '@wanghe1995/docx-editor-schema'
import { IElement } from '@wanghe1995/docx-editor-schema'
import { IPasteOption } from '@wanghe1995/docx-editor-schema'
import {
  getClipboardData,
...
import { IOverrideResult } from '../../plugin/override/Override'
import { normalizeLineBreak } from '@wanghe1995/docx-editor-schema'
...
export async function pasteByApi(host: CanvasEvent, options?: IPasteOption) {
  ...
  try {
    ...
    clipboardText = editorClipboardData?.text || ''
  }
  if (
    editorClipboardData &&
    normalizeLineBreak(clipboardText) ===
  ...
  if (options?.isPlainText) {
    ...
    let clipboardData: ClipboardItem[] = []
    try {
