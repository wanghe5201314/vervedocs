      ...
      <a-dropdown :trigger="['click']">
        ...
        <template #overlay>
          <a-menu @click="({ key }: any) => emit('lineHeight', Number(key))">
            <a-menu-item v-for="lh in lineHeightOptions" :key="lh.value">{{
              lh.label
            }}</a-menu-item>
          </a-menu>
        </template>
      ...
      <a-dropdown :trigger="['click']">
        ...
        <template #overlay>
          <a-menu
            ...
            "
          >
            <a-menu-item v-for="o in firstLineIndentOptions" :key="o.value">{{
              o.label
            }}</a-menu-item>
          </a-menu>
        </template>
...
import {
  characterScaleOptions,
  firstLineIndentOptions
} from '../../toolbar/ribbon-tabs'
