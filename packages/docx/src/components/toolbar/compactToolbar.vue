        ...
        <template #content>
          <div class="list-panel">
            ...
            <div class="list-grid bullet-grid">
              ...
              <button v-for="b in BULLET_STYLES" :key="b.style" class="list-cell" :title="b.label" @click="emit('bullet', b.style)">
        ...
        <template #content>
          <div class="list-panel">
            ...
            <div class="list-grid number-grid">
              ...
              <button v-for="n in NUMBER_STYLES" :key="n.style" class="list-cell" :title="n.label" @click="emit('number', n.style)">
                <div class="list-preview">
...
/* 禁用按钮 */
.tb:disabled { color: #c0c4cc !important; cursor: not-allowed !important; opacity: 0.6; }
.tb:disabled:hover { background: transparent !important; }
.tb:disabled i { color: #c0c4cc !important; }
</style>
