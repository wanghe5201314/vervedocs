<template>
  <div ref="sheetEditorRef" class="sheet-editor" @keydown="handleGlobalKeydown">
      ...
      <div class="menu-card">
        <div class="ribbon-tabs-bar">
          <div
            ...
            :key="tab.key"
            v-show="
              tab.key !== 'collab' || collabConnectionState === 'connected'
            "
            class="ribbon-tab"
        ...
        <div
          class="ribbon-panel"
          @mousedown.capture="handleRibbonStyleMouseDownCapture"
        >
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="handleCreateNewWorkbook()"
                  title="新建表格"
                >
                  <VIcon name="plus" /><span>新建</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  @click="handleSave()"
                  title="保存"
                >
                  <VIcon name="content-save-outline" /><span>保存</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  @click="handlePrint()"
                  title="打印"
                >
                  <VIcon name="printer-outline" /><span>打印</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  ...
                  title="导入表格"
                >
                  <VIcon name="file-excel-box" /><span>导入</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  ...
                  title="导出 Excel"
                >
                  <VIcon name="file-excel-box" /><span>导出</span>
                </button>
              </div>
          ...
          <div v-else-if="activeMenuTab === 'home'" class="ribbon-tab-panel">
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <a-select
                  v-model:value="toolbarState.fontFamily"
                  size="small"
                  style="width: 110px"
                  :disabled="readOnly"
                  @mousedown="handleFontSelectMouseDown"
                ...
                <a-select
                  v-model:value="toolbarState.fontSize"
                  size="small"
                  style="width: 60px"
                  :disabled="readOnly"
                  @change="updateCellStyle()"
                >
                  <a-select-option
                ...
                <button
                  ...
                  title="粗体 (Ctrl+B)"
                >
                  <VIcon name="format-bold" /><span>加粗</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="斜体 (Ctrl+I)"
                >
                  <VIcon name="format-italic" /><span>斜体</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="下划线 (Ctrl+U)"
                >
                  <VIcon name="format-underline" /><span>下划线</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="删除线"
                >
                  <VIcon name="format-strikethrough" /><span>删除线</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <a-popover placement="bottom" :width="260" trigger="click">
                  ...
                  <template #default>
                    <button
                      class="ribbon-btn-lg color-btn"
                      :disabled="readOnly"
                      title="字体颜色"
                    >
                      <VIcon name="format-color-text" /><span>字色</span
                      ><span
                        class="color-bar"
                        :style="{
                          backgroundColor: toolbarState.fontColor || '#000000'
                        }"
                      ></span>
                    </button>
                  </template>
                ...
                <a-popover placement="bottom" :width="260" trigger="click">
                  ...
                  <template #default>
                    <button
                      ...
                      title="填充颜色"
                    >
                      <VIcon name="format-color-fill" /><span>填充</span
                      ><span
                        class="color-bar"
                        :style="{
                          backgroundColor: toolbarState.bgColor || '#ffffff'
                        }"
                      ></span>
                    </button>
                  </template>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <a-popover placement="bottom" :width="140" trigger="click">
                  <template #content>
                    <div class="align-panel">
                      ...
                      <button
                        class="align-btn"
                        :class="{ active: toolbarState.align === 'left' }"
                        @click="setAlign('left')"
                      >
                        <VIcon name="format-align-left" /><span>左对齐</span>
                      </button>
                      <button
                        class="align-btn"
                        :class="{ active: toolbarState.align === 'center' }"
                        @click="setAlign('center')"
                      >
                        <VIcon name="format-align-center" /><span>居中</span>
                      </button>
                      <button
                        class="align-btn"
                        :class="{ active: toolbarState.align === 'right' }"
                        @click="setAlign('right')"
                      >
                        <VIcon name="format-align-right" /><span>右对齐</span>
                      </button>
                      ...
                      <button
                        class="align-btn"
                        :class="{
                          active: toolbarState.verticalAlign === 'top'
                        }"
                        @click="setVerticalAlign('top')"
                      >
                        <VIcon name="format-vertical-align-top" /><span
                          >顶部</span
                        >
                      </button>
                      <button
                        class="align-btn"
                        :class="{
                          active: toolbarState.verticalAlign === 'middle'
                        }"
                        @click="setVerticalAlign('middle')"
                      >
                        <VIcon name="format-vertical-align-center" /><span
                          >居中</span
                        >
                      </button>
                      <button
                        class="align-btn"
                        :class="{
                          active: toolbarState.verticalAlign === 'bottom'
                        }"
                        @click="setVerticalAlign('bottom')"
                      >
                        <VIcon name="format-vertical-align-bottom" /><span
                          >底部</span
                        >
                      </button>
                    </div>
                  ...
                  <template #default>
                    ...
                    >
                      <VIcon
                        :name="'format-align-' + (toolbarState.align || 'left')"
                      /><span>对齐</span>
                    </button>
                  </template>
                </a-popover>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  :class="{ active: toolbarState.wrap === 'wrap' }"
                  @click="toggleWrap()"
                  title="自动换行"
                >
                  <VIcon name="text-wrap" /><span>换行</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <a-select
                  v-model:value="toolbarState.numberFormat"
                  size="small"
                  style="width: 80px"
                  :disabled="readOnly"
                  @change="updateCellStyle()"
                ...
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="quickFormat('currency')"
                  title="货币格式 (¥)"
                >
                  <VIcon name="currency-usd" /><span>货币</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="quickFormat('percent')"
                  title="百分比格式 (%)"
                >
                  <VIcon name="percent" /><span>百分比</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="changeDecimal(-1)"
                  title="减少小数位"
                >
                  <VIcon name="decimal-decrease" /><span>减位</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="增加小数位"
                >
                  <VIcon name="decimal-increase" /><span>增位</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                  ...
                  <template #content>
                    <div class="border-panel">
                      <div class="border-grid">
                        <button
                          class="border-btn"
                          @click="setBorders('all')"
                          title="所有边框"
                        >
                          <svg viewBox="0 0 24 24" width="20" height="20">
                            <path
                              fill="currentColor"
                              d="M3,3V21H21V3H3M19,19H13V13H19V19M19,11H13V5H19V11M11,19H5V13H11V19M11,11H5V5H11V11Z"
                            />
                          </svg>
                        </button>
                        <button
                          class="border-btn"
                          @click="setBorders('outer')"
                          title="外侧边框"
                        >
                          <svg viewBox="0 0 24 24" width="20" height="20">
                            <path
                              fill="currentColor"
                              d="M3,3V21H21V3H3M19,5V19H5V5H19Z"
                            />
                          </svg>
                        </button>
                        <button
                          class="border-btn"
                          @click="setBorders('none')"
                          title="无边框"
                        >
                          <svg viewBox="0 0 24 24" width="20" height="20">
                            <path
                              fill="currentColor"
                              d="M3,3V5H5V3H3M7,3V5H9V3H7M11,3V5H13V3H11M15,3V5H17V3H15M19,3V5H21V3H19M3,7V9H5V7H3M19,7V9H21V7H19M3,11V13H5V11H3M19,11V13H21V11H19M3,15V17H5V15H3M19,15V17H21V15H19M3,19V21H5V19H3M7,19V21H9V19H7M11,19V21H13V19H11M15,19V21H17V19H15M19,19V21H21V19H19Z"
                            />
                          </svg>
                        </button>
                        <button
                          class="border-btn"
                          @click="setBorders('bottom')"
                          title="下边框"
                        >
                          <svg viewBox="0 0 24 24" width="20" height="20">
                            <path fill="currentColor" d="M3,19V21H21V19H3Z" />
                          </svg>
                        </button>
                        <button
                          class="border-btn"
                          @click="setBorders('top')"
                          title="上边框"
                        >
                          <svg viewBox="0 0 24 24" width="20" height="20">
                            <path fill="currentColor" d="M3,3V5H21V3H3Z" />
                          </svg>
                        </button>
                        <button
                          class="border-btn"
                          @click="setBorders('left')"
                          title="左边框"
                        >
                          <svg viewBox="0 0 24 24" width="20" height="20">
                            <path fill="currentColor" d="M3,3V21H5V3H3Z" />
                          </svg>
                        </button>
                        <button
                          class="border-btn"
                          @click="setBorders('right')"
                          title="右边框"
                        >
                          <svg viewBox="0 0 24 24" width="20" height="20">
                            <path fill="currentColor" d="M19,3V21H21V3H19Z" />
                          </svg>
                        </button>
                      </div>
                    </div>
                ...
                <button
                  ...
                  title="合并单元格"
                >
                  <VIcon name="table-merge-cells" /><span>合并</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="handleUnmergeCells()"
                  title="取消合并"
                >
                  <VIcon name="table-split-cell" /><span>取消合并</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="清除格式"
                >
                  <VIcon name="format-clear" /><span>清格式</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="showRowHeightDialog = true"
                  title="行高"
                >
                  <VIcon name="arrow-expand-vertical" /><span>行高</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="autoFitRowHeight()"
                  title="自动行高"
                >
                  <VIcon name="arrow-fit-vertical" /><span>自动行高</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="showColWidthDialog = true"
                  title="列宽"
                >
                  <VIcon name="arrow-expand-horizontal" /><span>列宽</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="autoFitColWidth()"
                  title="自动列宽"
                >
                  <VIcon name="arrow-fit-horizontal" /><span>自动列宽</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                ...
                <button
                  ...
                  title="重做 (Ctrl+Y)"
                >
                  <VIcon name="redo" /><span>重做</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="handleFormatPainter()"
                  :class="{ active: formatPainterActive }"
                  title="格式刷"
                >
                  <VIcon name="format-paint" /><span>格式刷</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  ...
                  title="剪切 (Ctrl+X)"
                >
                  <VIcon name="content-cut" /><span>剪切</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="复制 (Ctrl+C)"
                >
                  <VIcon name="content-copy" /><span>复制</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="粘贴 (Ctrl+V)"
                >
                  <VIcon name="content-paste" /><span>粘贴</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  ...
                  title="全选 (Ctrl+A)"
                >
                  <VIcon name="select-all" /><span>全选</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="删除内容 (Delete)"
                >
                  <VIcon name="delete-outline" /><span>删除</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                ...
                <button
                  class="ribbon-btn-lg"
                  @click="openUniverReplaceDialog()"
                  title="查找和替换 (Ctrl+H)"
                >
                  <VIcon name="magnify" /><span>查找</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  ...
                  title="删除行"
                >
                  <VIcon name="table-row-remove" /><span>删行</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="删除列"
                >
                  <VIcon name="table-column-remove" /><span>删列</span>
                </button>
              </div>
              <div class="ribbon-group-title">行列</div>
            </div>
          ...
          <div v-else-if="activeMenuTab === 'view'" class="ribbon-tab-panel">
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  ...
                  title="网格线"
                >
                  <VIcon name="grid" /><span>网格线</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  @click="showFormulaBar = !showFormulaBar"
                  :class="{ active: showFormulaBar }"
                  title="编辑栏"
                >
                  <VIcon name="function-variant" /><span>编辑栏</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  class="ribbon-btn-lg"
                  @click="setZoom(50)"
                  :class="{ active: zoomLevel === 50 }"
                  title="50%"
                >
                  <VIcon name="magnify-minus" /><span>50%</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  @click="setZoom(75)"
                  :class="{ active: zoomLevel === 75 }"
                  title="75%"
                >
                  <VIcon name="magnify-minus" /><span>75%</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  @click="setZoom(100)"
                  ...
                  title="100%"
                >
                  <VIcon name="magnify" /><span>100%</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  @click="setZoom(125)"
                  :class="{ active: zoomLevel === 125 }"
                  title="125%"
                >
                  <VIcon name="magnify-plus" /><span>125%</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  @click="setZoom(150)"
                  :class="{ active: zoomLevel === 150 }"
                  title="150%"
                >
                  <VIcon name="magnify-plus" /><span>150%</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  @click="setZoom(200)"
                  :class="{ active: zoomLevel === 200 }"
                  title="200%"
                >
                  <VIcon name="magnify-plus" /><span>200%</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  class="ribbon-btn-lg"
                  @click="toggleFreezeRow()"
                  :class="{ active: frozenRows > 0 }"
                  title="冻结首行"
                >
                  <VIcon name="snowflake" /><span>{{
                    frozenRows > 0 ? '取消冻结行' : '冻结首行'
                  }}</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  @click="toggleFreezeCol()"
                  :class="{ active: frozenCols > 0 }"
                  title="冻结首列"
                >
                  <VIcon name="snowflake" /><span>{{
                    frozenCols > 0 ? '取消冻结列' : '冻结首列'
                  }}</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="toggleUniverFilter()"
                  title="筛选"
                >
                  <VIcon name="filter-outline" /><span>筛选</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  ...
                  title="在上方插入行"
                >
                  <VIcon name="table-row-plus-before" /><span>上方插行</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="在下方插入行"
                >
                  <VIcon name="table-row-plus-after" /><span>下方插行</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="在左侧插入列"
                >
                  <VIcon name="table-column-plus-before" /><span>左侧插列</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="在右侧插入列"
                >
                  <VIcon name="table-column-plus-after" /><span>右侧插列</span>
                </button>
              </div>
              <div class="ribbon-group-title">行列</div>
            </div>
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="openUniverHyperlink()"
                  title="插入链接"
                >
                  <VIcon name="link-variant" /><span>链接</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="插入图片"
                >
                  <VIcon name="image-outline" /><span>图片</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="openUniverNote()"
                  title="便签"
                >
                  <VIcon name="note-text-outline" /><span>便签</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="openUniverThreadComment()"
                  title="评论"
                >
                  <VIcon name="comment-plus-outline" /><span>评论</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <a-popover placement="bottom" :width="150" trigger="click">
                  <template #content>
                    <div class="align-panel">
                      <button class="align-btn" @click="insertFunction('SUM')">
                        <span>SUM 求和</span>
                      </button>
                      <button
                        class="align-btn"
                        @click="insertFunction('AVERAGE')"
                      >
                        <span>AVERAGE 平均值</span>
                      </button>
                      <button
                        class="align-btn"
                        @click="insertFunction('COUNT')"
                      >
                        <span>COUNT 计数</span>
                      </button>
                      <button class="align-btn" @click="insertFunction('MAX')">
                        <span>MAX 最大值</span>
                      </button>
                      <button class="align-btn" @click="insertFunction('MIN')">
                        <span>MIN 最小值</span>
                      </button>
                    </div>
                  </template>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  :class="{ active: toolbarState.wrap === 'clip' }"
                  @click="setWrap('clip')"
                  title="裁剪"
                >
                  <VIcon name="crop" /><span>裁剪</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  :class="{ active: toolbarState.wrap === 'overflow' }"
                  @click="setWrap('overflow')"
                  title="溢出"
                >
                  <VIcon name="arrow-right" /><span>溢出</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  :class="{ active: toolbarState.rotation === 0 }"
                  @click="setRotation(0)"
                  title="无旋转"
                >
                  <VIcon name="format-text-rotation-none" /><span>无旋转</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  :class="{ active: toolbarState.rotation === 45 }"
                  @click="setRotation(45)"
                  title="向上倾斜"
                >
                  <VIcon name="format-text-rotation-up" /><span>向上</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="向下倾斜"
                >
                  <VIcon name="format-text-rotation-down" /><span>向下</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  :class="{ active: toolbarState.rotation === 90 }"
                  @click="setRotation(90)"
                  title="竖排文字"
                >
                  <VIcon name="format-text-rotation-vertical" /><span
                    >竖排</span
                  >
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  ...
                  title="隐藏行"
                >
                  <VIcon name="eye-off-outline" /><span>隐藏行</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="取消隐藏行"
                >
                  <VIcon name="eye-outline" /><span>显示行</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="隐藏列"
                >
                  <VIcon name="eye-off-outline" /><span>隐藏列</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="取消隐藏列"
                >
                  <VIcon name="eye-outline" /><span>显示列</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="openUniverSort('asc')"
                  title="升序排序"
                >
                  <VIcon name="sort-ascending" /><span>升序</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="openUniverSort('desc')"
                  title="降序排序"
                >
                  <VIcon name="sort-descending" /><span>降序</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  @click="openUniverDataValidation()"
                  title="数据验证"
                >
                  <VIcon name="check-circle-outline" /><span>验证</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  :disabled="readOnly"
                  ...
                  title="删除重复值"
                >
                  <VIcon name="table-minus" /><span>去重</span>
                </button>
              </div>
          ...
          <div
            v-else-if="
              activeMenuTab === 'collab' &&
              collabConnectionState === 'connected'
            "
            class="ribbon-tab-panel"
          >
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  class="ribbon-btn-lg"
                  @click="toggleSyncSelection()"
                  :class="{ active: syncSelectionEnabled }"
                  title="显示/隐藏他人选区"
                >
                  <VIcon name="cursor-default" /><span>{{
                    syncSelectionEnabled ? '隐藏选区' : '显示选区'
                  }}</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  @click="toggleSyncFilter()"
                  :class="{ active: syncFilterEnabled }"
                  title="显示/隐藏他人筛选"
                >
                  <VIcon name="filter-outline" /><span>{{
                    syncFilterEnabled ? '隐藏筛选' : '显示筛选'
                  }}</span>
                </button>
                <button
                  class="ribbon-btn-lg"
                  @click="toggleSyncSort()"
                  :class="{ active: syncSortEnabled }"
                  title="显示/隐藏他人排序"
                >
                  <VIcon name="sort-ascending" /><span>{{
                    syncSortEnabled ? '隐藏排序' : '显示排序'
                  }}</span>
                </button>
              </div>
            ...
            <div class="ribbon-group">
              <div class="ribbon-group-content">
                <button
                  ...
                  title="键盘快捷键"
                >
                  <VIcon name="keyboard-outline" /><span>快捷键</span>
                </button>
              </div>
    ...
    <div v-if="showFormulaBar" class="formula-row">
      <div class="cell-ref" @click="selectCellRefInput()">
        {{ currentCellRef }}
      </div>
      <input
        ref="formulaInputRef"
    ...
    >
      <div class="shortcuts-list">
        <div class="shortcut-group">
          <div v-for="s in SHORTCUT_ENTRIES" :key="s.keys" class="shortcut-row">
            <span>{{ s.label }}</span
            ><kbd>{{ s.keys }}</kbd>
          </div>
        </div>
    ...
    <!-- 行高对话框 -->
    <a-modal
      v-model:open="showRowHeightDialog"
      title="设置行高"
      width="360px"
      @ok="applyRowHeight"
    >
    ...
    <!-- 列宽对话框 -->
    <a-modal
      v-model:open="showColWidthDialog"
      title="设置列宽"
      width="360px"
      @ok="applyColWidth"
    >
...
import type {
  ...
  UserInfo
} from '@vervedoc/docx-editor-collaboration'
...
import type {
  SheetCommandContext,
  SheetCoreContext
} from '@/composables/sheet-editor-context'
import {
  COLOR_PALETTE,
  FONT_OPTIONS,
  MENU_TABS,
...
const emit = defineEmits<{
  ...
  (
    ...
    payload: {
      dbPayload: any
      excelPayload: { fileName: string; mimeType: string; buffer: ArrayBuffer }
    }
  ): void
  (
    e: 'collabConnectionChange',
    payload: { state: ConnectionState | string }
  ): void
...
const workbookStateOptions = {
  defaultSheetName: (index: number) =>
    t('sheet.defaultSheetName', { index: index + 1 }),
...
// ===== 编辑器可变状态 =====
const workbook = reactive<IWorkbook>(
  normalizeWorkbook(props.initialContent, workbookStateOptions)
)
...
const activeSheet = computed(
  () => workbook.sheets[activeSheetIndex.value] || workbook.sheets[0]
)
const currentRows = computed(() =>
  Array.from(
    { length: Math.max(1, activeSheet.value?.rowCount || 50) },
    (_, i) => i
  )
)
const currentColumns = computed(() =>
  Array.from(
    { length: Math.max(1, activeSheet.value?.colCount || 26) },
    (_, i) => i
  )
)
...
function getUniverLocaleType(runtime: LoadedUniverRuntime) {
  return props.locale === 'enUS'
    ? runtime.core.LocaleType.EN_US
    : runtime.core.LocaleType.ZH_CN
}
...
async function executeUniverCommand(
  commandId: string,
...
async function executeSheetCommand(
  commandId: string,
  params?: Record<string, any>
) {
...
async function commitActiveCellEdit(
  ...
  const restoreTarget =
    target || pendingStyleTargetCell.value || editingCell.value
  try {
...
async function handleRibbonStyleMouseDownCapture(event: MouseEvent) {
  ...
  pendingStyleTargetCell.value = editingCell.value || {
    row: selected.row,
    col: selected.col
  }
...
function bindUniverEvents() {
  ...
  if (!univerAPI) return
  univerWorkbookDisposables.push(
    univerAPI.addEvent(
...
function syncWorkbookFromUniver() {
  ...
  workbook.resources =
    extracted.resources && typeof extracted.resources === 'object'
  ...
  workbook.sheets = extracted.sheets.map((sheet, index) => {
    ...
    for (const [key, meta] of Object.entries(mergedMeta)) {
      if (!meta || typeof meta !== 'object' || meta.comment === undefined)
        continue
      const rest = { ...meta }
      delete rest.comment
...
function syncDimensionStateFromActiveSheet() {
  ...
  frozenRows.value = Number.isFinite(sheet.frozenRows)
    ? Number(sheet.frozenRows)
    : 0
  frozenCols.value = Number.isFinite(sheet.frozenCols)
    ? Number(sheet.frozenCols)
    : 0
...
function loadFilterStateFromActiveSheet() {
  ...
  resetFilterState()
  if (!sheet) return
  filterColumn.value = Number.isFinite(sheet.filterColumn)
    ? Number(sheet.filterColumn)
    : null
...
function updateSelectionFromUniver() {
  ...
  const nextIndex = workbook.sheets.findIndex(
    sheet => sheet.id === univerActiveSheet.getSheetId()
  )
  if (nextIndex >= 0) {
...
async function renderLuckysheet() {
  ...
  try {
    ...
    const univerWorkbookData = runtime.adapter.internalWorkbookToUniver(
      workbook,
      props.locale
    )
    if (univerWorkbookData.resources) {
      workbook.resources = JSON.parse(
        JSON.stringify(univerWorkbookData.resources)
      )
    }
    ...
    lastUniverSnapshot = activeUniverWorkbook
      ? JSON.stringify(activeUniverWorkbook.save())
      : ''
...
function handleGlobalKeydown(e: KeyboardEvent) {
  ...
  if (target?.closest('.univer-host') || target?.closest('[class*="univer"]'))
    return
  ...
  if (ctrl) {
    switch (e.key.toLowerCase()) {
      ...
      case 'f':
        e.preventDefault()
        void openUniverFindDialog()
        return
      case 'h':
        e.preventDefault()
        void openUniverReplaceDialog()
        return
      case 'p':
        e.preventDefault()
        handlePrint()
...
function currentWorkbookFileName(): string {
  const name =
    stripSpreadsheetExtension(headerTitle.value) || t('sheet.defaultTitle')
  return `${name}.xlsx`
}
...
async function handleImportExcelChange(e: Event) {
  ...
  try {
    ...
    applyWorkbookState(result.workbook)
    localDocumentTitle.value =
      stripSpreadsheetExtension(file.name) || t('sheet.defaultTitle')
    scheduleUniverRender()
    emitChange()
...
async function handleExportExcel() {
  ...
  try {
    ...
    const msg =
      error instanceof Error ? error.message : t('message.exportFailed')
    message.error(msg)
  }
}
...
async function handleCreateNewWorkbook() {
  ...
  try {
    ...
    const msg =
      error instanceof Error ? error.message : t('message.createFailed')
    message.error(msg)
  }
}
...
function emitChange(source: 'internal' | 'univer' = 'internal') {
  ...
  headerLastSaveTime.value = new Date().toLocaleTimeString('zh-CN', {
    hour: '2-digit',
    minute: '2-digit'
  })
  const payload = {
