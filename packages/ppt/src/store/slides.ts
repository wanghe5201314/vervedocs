...
import { OFFICE_VIEWPORT_RATIO, OFFICE_VIEWPORT_WIDTH } from '@/configs/canvas'
...
export const useSlidesStore = defineStore('slides', {
  state: (): SlidesState => ({
    ...
    slideIndex: 0, // 当前页面索引
    viewportRatio: OFFICE_VIEWPORT_RATIO,
    viewportWidth: OFFICE_VIEWPORT_WIDTH,
  }),
  ...
  actions: {
    ...
    setViewportRatio(viewportRatio: number) {
      this.viewportRatio = OFFICE_VIEWPORT_RATIO
      this.viewportWidth = OFFICE_VIEWPORT_WIDTH
    },
