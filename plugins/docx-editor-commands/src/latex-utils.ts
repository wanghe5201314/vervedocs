import { HERSHEY } from './latex-hershey'
import { SYMB, Symb, asciiMap } from './latex-symbols'
...
/**
 * 将扁平化后的表达式渲染为多段折线（用于 SVG/Canvas/PDF 输出）
 * @param expr 表达式
 * @returns 折线坐标数组
 */
...
/** LaTeX 工具类，提供从 LaTeX 字符串到 SVG/PDF/折线的转换能力 */
