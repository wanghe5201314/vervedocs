import type { IElement, IEditorOption, Path, ISearchResult, IReplaceOption, INavigateInfo } from '@vervedoc/docx-editor-schema'
...
export type { ISearchResult, IReplaceOption, INavigateInfo } from '@vervedoc/docx-editor-schema'
...
export class Search {
   ...
   * 在指定页块的子块中查找匹配矩形
   * @param blocks 块列表
   * @param originX 起始 X 偏移
   * @param originY 起始 Y 偏移
   * @param pageNo 页码
   * @param match 匹配结果
   * @returns 矩形坐标或 null
   */
