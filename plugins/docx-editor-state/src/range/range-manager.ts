import { ElementType, ZERO, TEXTLIKE_ELEMENT_TYPE, ControlComponent, EditorContext, IControlContext, IElement, IRangeStyle, IRange, IRangeElementStyle, IRangeParagraphInfo, RangeRowArray, RangeRowMap, getAnchorElement, isParagraphSeparator } from '@vervedoc/docx-editor-schema'
type Draw = any
