import { EDITOR_COMPONENT } from '@vervedoc/docx-editor-schema'
import { IEditorOption } from '@vervedoc/docx-editor-schema'
import { findParent } from '@vervedoc/docx-editor-schema'
import { Cursor } from '../renders/cursor'
...
import { INTERNAL_SHORTCUT_KEY } from '@vervedoc/docx-editor-schema'
