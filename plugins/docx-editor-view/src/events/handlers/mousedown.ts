...
import { MouseEventButton } from '@vervedoc/docx-editor-schema'
import { ControlComponent } from '@vervedoc/docx-editor-schema'
import { ControlType } from '@vervedoc/docx-editor-schema'
import { IPreviewerDrawOption } from '@vervedoc/docx-editor-schema'
import { deepClone } from '@vervedoc/docx-editor-schema'
import { isMod } from '@vervedoc/docx-editor-schema'
import { CheckboxControl } from '../../widgets/checkbox'
import { RadioControl } from '../../widgets/radio'
...
export function mousedown(evt: MouseEvent, host: CanvasEvent) {
  ...
  if (isDirectHitImage) {
    ...
    if (eventBus.hasSubscribers('imageMousedown')) {
