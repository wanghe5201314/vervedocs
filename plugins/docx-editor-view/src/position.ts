import { ListStyle, RowFlex, ElementType, VerticalAlign } from '@vervedoc/docx-editor-schema'
import { ZERO } from '@vervedoc/docx-editor-schema'
import { ControlComponent } from '@vervedoc/docx-editor-schema'
import {
...
import { deepClone, isRectIntersect } from '@vervedoc/docx-editor-schema'
...
import { getIsBlockElement, isTableElement, isImageElement } from '@vervedoc/docx-editor-schema'
    ...
    for (let i = 0; i < rowList.length; i++) {
      ...
      for (let j = 0; j < curRow.elementList.length; j++) {
        ...
        if (
          ...
          } else if (element.imgFloatPosition.pageNo === undefined) {
            element.imgFloatPosition.pageNo = pageNo
          }
