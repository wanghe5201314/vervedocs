...
export const useMainStore = defineStore('main', {
  state: (): MainState => ({
    activeElementIdList: [], // 被选中的元素 ID 集合，包含 handleElementId
    handleElementId: '', // 正在操作的元素 ID
    activeGroupElementId: '', // 组合元素成员中，被选中可独立操作的元素 ID
    canvasPercentage: 100, // 画布缩放百分比，默认显示 100%
    canvasScale: 0.95, // 画布缩放比例（实际大小为 95%）
