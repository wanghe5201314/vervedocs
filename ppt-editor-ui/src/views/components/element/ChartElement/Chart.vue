...
.chart-content {
  ...
  @for $i from 1 to list.length($ct-series-names) {
    $color: var(--theme-color-#{$i});

    .ct-series-#{list.nth($ct-series-names, $i)} .ct-line {
      stroke: $color;
    }
    .ct-series-#{list.nth($ct-series-names, $i)} .ct-point {
      stroke: $color;
    }
    .ct-series-#{list.nth($ct-series-names, $i)} .ct-area {
      fill: $color;
    }
    .ct-series-#{list.nth($ct-series-names, $i)} .ct-bar {
      stroke: $color;
    }
    .ct-series-#{list.nth($ct-series-names, $i)} .ct-slice-pie {
      fill: $color;
    }
    .ct-series-#{list.nth($ct-series-names, $i)} .ct-slice-donut {
      stroke: $color;
    }
  }
