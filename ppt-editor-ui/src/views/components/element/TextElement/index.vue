    ...
    >
      ...
      >
        ...
        <ProsemirrorEditor
          ...
          @blur="checkEmptyText()"
          @mousedown="($event: any) => handleSelectElement($event, false)"
        />
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const textInsetsPadding = computed(() => {
      const insets = props.elementInfo.textInsets
      if (!insets) return '10px'
      return `${insets[0]}px ${insets[1]}px ${insets[2]}px ${insets[3]}px`
    })
