...
export class RevisionOverlay {
  ...
  private _getRevisions(): Array<{
    id: string; type: 'delete'; author: string; date: string; content: string; firstIndex: number
  }> {
    const elementList = this.draw.getElementList()
    const revisionMap = new Map<string, { id: string; type: 'delete'; author: string; date: string; content: string; firstIndex: number }>()
